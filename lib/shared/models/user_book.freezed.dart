...
mixin _$UserBook {
 ...
 String get id; Book get book; UserBookStatus get status; int get currentPage; bool get isFavorite; double? get userRating; DateTime? get addedAt; DateTime? get startedAt; DateTime? get finishedAt; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,book,status,currentPage,isFavorite,userRating,addedAt,startedAt,finishedAt,updatedAt);

@override
String toString() {
  return 'UserBook(id: $id, book: $book, status: $status, currentPage: $currentPage, isFavorite: $isFavorite, userRating: $userRating, addedAt: $addedAt, startedAt: $startedAt, finishedAt: $finishedAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, Book book, UserBookStatus status, int currentPage, bool isFavorite, double? userRating, DateTime? addedAt, DateTime? startedAt, DateTime? finishedAt, DateTime? updatedAt
});
...
/// Create a copy of UserBook
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? book = null,Object? status = null,Object? currentPage = null,Object? isFavorite = null,Object? userRating = freezed,Object? addedAt = freezed,Object? startedAt = freezed,Object? finishedAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  Book book,  UserBookStatus status,  int currentPage,  bool isFavorite,  double? userRating,  DateTime? addedAt,  DateTime? startedAt,  DateTime? finishedAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserBook() when $default != null:
return $default(_that.id,_that.book,_that.status,_that.currentPage,_that.isFavorite,_that.userRating,_that.addedAt,_that.startedAt,_that.finishedAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  Book book,  UserBookStatus status,  int currentPage,  bool isFavorite,  double? userRating,  DateTime? addedAt,  DateTime? startedAt,  DateTime? finishedAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _UserBook():
return $default(_that.id,_that.book,_that.status,_that.currentPage,_that.isFavorite,_that.userRating,_that.addedAt,_that.startedAt,_that.finishedAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  Book book,  UserBookStatus status,  int currentPage,  bool isFavorite,  double? userRating,  DateTime? addedAt,  DateTime? startedAt,  DateTime? finishedAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _UserBook() when $default != null:
return $default(_that.id,_that.book,_that.status,_that.currentPage,_that.isFavorite,_that.userRating,_that.addedAt,_that.startedAt,_that.finishedAt,_that.updatedAt);case _:
  return null;
...
class _UserBook implements UserBook {
  const _UserBook({required this.id, required this.book, this.status = UserBookStatus.wantToRead, this.currentPage = 0, this.isFavorite = false, this.userRating, this.addedAt, this.startedAt, this.finishedAt, this.updatedAt});
...
/// Create a copy of UserBook
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? book = null,Object? status = null,Object? currentPage = null,Object? isFavorite = null,Object? userRating = freezed,Object? addedAt = freezed,Object? startedAt = freezed,Object? finishedAt = freezed,Object? updatedAt = freezed,}) {
